...
# Quick sanity check for a saved Generator
# Author: Callum Musselwhite
# Last edit: 2025-09-17
# Purpose: load generator weights, draw a small batch, and print basic stats
...
def main():
    # load generator weights from C.MODEL_OUT_DIR
    G = Generator().to('cpu')
